...
images = [ ##################################fine images
    ...
    "dataset_immagini/aereo.png",
    "dataset_immagini/gattoGhibli.png",
    "dataset_immagini/gattoTest.png",
    "dataset_immagini/orsoTest.png",
    "dataset_immagini/gattoTRAK.png",
    "dataset_immagini/caneTRAK.png",
    "dataset_immagini/gattoPNG.png",
    "dataset_immagini/aereoPNG.png",
    "dataset_immagini/gattoEaereoPNG.png",
    "dataset_immagini/gattoEaereoPNG2.png",
